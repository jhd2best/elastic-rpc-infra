# set'up the IAM role for the EC2 instances


# this role was created manually since the terraform user doesnt have iam permissions
...
resource "aws_iam_instance_profile" "nomad" {
  ...
  role = data.aws_iam_role.nomad.name
}
